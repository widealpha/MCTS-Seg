...
def calculate_mean_and_variance_iou(mask_dir, ground_truth_dir):
    iou_results = []
    images = os.listdir(ground_truth_dir)
    images.sort()
    image_ids = [extract_image_id(image) for image in images]
...
def calculate_mean_and_variance_dice(mask_dir, ground_truth_dir):
    dice_results = []
    images = os.listdir(ground_truth_dir)
    images.sort()
    image_ids = [extract_image_id(image) for image in images]
...
def calculate_score_with_variance(mask_dir, ground_truth_dir, score_type='iou'):
    if score_type == 'iou':
        mean, variance = calculate_mean_and_variance_iou(mask_dir, ground_truth_dir)
    elif score_type == 'dice':
        mean, variance = calculate_mean_and_variance_dice(mask_dir, ground_truth_dir)
...
def main():
    ...
    score_mean, score_variance = calculate_score_with_variance(mcts, ground_truth_dir, score_type)
    ...
    score_mean, score_variance = calculate_score_with_variance(one_fg, ground_truth_dir, score_type)
    print(f"[Best Reward] One Fg Mean {score_type}: {score_mean}, Variance: {score_variance}")
    score_mean, score_variance = calculate_score_with_variance(one_bg_one_fg, ground_truth_dir, score_type)
    print(f"[Best Reward] One Bg One Fg Mean {score_type}: {score_mean}, Variance: {score_variance}")
    score_mean, score_variance = calculate_score_with_variance(one_bg_two_fg, ground_truth_dir, score_type)
    print(f"[Best Reward] One Bg Two Fg Mean {score_type}: {score_mean}, Variance: {score_variance}")
