...
def generate_data(train=False, use_best_point=False):
    ...
    if use_best_point:
        ...
        #                ground_truth_dir=ground_truth_dir)
        # sam_point_mask(point_number=2, grid_size=20, in_dir=raw_image_dir, out_dir=point_masks_dir,
        #                ground_truth_dir=ground_truth_dir)
        # sam_point_mask(point_number=3, grid_size=20, in_dir=raw_image_dir, out_dir=point_masks_dir,
        #                ground_truth_dir=ground_truth_dir)
        # 选择最佳奖励图像
