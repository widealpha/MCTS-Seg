...
def process(input_dir, output_dir, mode='train'):
    # Define the paths
    input_dir = '/home/kmh/Ependymoma'
    output_image_dir = f'{output_dir}/image'
    output_gt_dir = f'{output_dir}/ground_truth'
...
if __name__ == '__main__':
    input_base_dir = '/home/kmh/Ependymoma'
    output_base_dir = 'data/Ependymoma/raw'
    process(input_base_dir,
            os.path.join(output_base_dir, 'train/image'))
    process(os.path.join(input_base_dir, 'train/ground_truth'),
            os.path.join(output_base_dir, 'train/gt'))
    process(os.path.join(input_base_dir, 'test/image'),
            os.path.join(output_base_dir, 'test/image'))
    process(os.path.join(input_base_dir, 'test/ground_truth'),
