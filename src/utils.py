...
# log_writer = SummaryWriter(f'logs/{datetime.now().strftime("%Y-%m-%d_%H-%M-%S")}')
...
def load_sam():
    sam = sam_model_registry["vit_h"](checkpoint="/home/kmh/projects/ai/mcts-seg/sam_vit_h_4b8939.pth")
    sam.eval()
