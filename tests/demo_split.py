...
k_tk512, _, iou_tk512, iou_std_tk512, dice_tk512, dice_std_tk512 = parse_data(
    data_tk512)
...
plt.plot(k_smooth_t8, iou_smooth_t8, color='blue', linewidth=linewidth)
plt.errorbar(k_t8, iou_t8, yerr=iou_std_t8, fmt='o', color='blue',
             capsize=5, markeredgewidth=markeredgewidth, elinewidth=elinewidth)
...
if len(yticks) > 2:
    ...
    plt.yticks(yticks)
plt.savefig('k_iou_dice_1.png', dpi=300, bbox_inches='tight')
plt.close()

plt.figure(figsize=fig_size)
plt.plot(k_smooth_t8, dice_smooth_t8, color='red', linewidth=linewidth)
plt.errorbar(k_t8, dice_t8, yerr=dice_std_t8, fmt='s', color='red',
             capsize=5, markeredgewidth=markeredgewidth, elinewidth=elinewidth)
plt.grid(True, alpha=0.5)
plt.tick_params(axis='both', which='major', labelsize=tick_fontsize)
plt.xticks([2, 4, 6, 8])
...
if len(yticks) > 2:
    ...
    plt.yticks(yticks)
plt.savefig('k_iou_dice_2.png', dpi=300, bbox_inches='tight')
plt.close()

plt.figure(figsize=fig_size)
plt.plot(k_smooth_tk512, iou_smooth_tk512, color='blue', linewidth=linewidth)
plt.errorbar(k_tk512, iou_tk512, yerr=iou_std_tk512, fmt='o', color='blue',
             capsize=5, markeredgewidth=markeredgewidth, elinewidth=elinewidth)
plt.grid(True, alpha=0.5)
plt.tick_params(axis='both', which='major', labelsize=tick_fontsize)
plt.xticks([2, 4, 6, 8])
...
if len(yticks) > 2:
    ...
    plt.yticks(yticks)
plt.savefig('k_iou_dice_3.png', dpi=300, bbox_inches='tight')
plt.close()

plt.figure(figsize=fig_size)
plt.plot(k_smooth_tk512, dice_smooth_tk512, color='red', linewidth=linewidth)
plt.errorbar(k_tk512, dice_tk512, yerr=dice_std_tk512, fmt='s', color='red',
             capsize=5, markeredgewidth=markeredgewidth, elinewidth=elinewidth)
plt.grid(True, alpha=0.5)
plt.tick_params(axis='both', which='major', labelsize=tick_fontsize)
plt.xticks([2, 4, 6, 8])
...
if len(yticks) > 2:
    ...
    plt.yticks(yticks)
plt.savefig('k_iou_dice_4.png', dpi=300, bbox_inches='tight')
plt.close()
